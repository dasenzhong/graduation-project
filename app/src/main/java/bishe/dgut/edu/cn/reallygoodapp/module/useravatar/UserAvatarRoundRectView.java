...
public class UserAvatarRoundRectView extends View {


    public UserAvatarRoundRectView(Context context) {
        super(context);
    }

    public UserAvatarRoundRectView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }

    public UserAvatarRoundRectView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
...
//            canvas.drawCircle(getWidth() / 2,getHeight() / 2,radius,paint);
            ...
            canvas.drawRoundRect(new RectF(0, 0, srcWidth, srcHeight), 10, 10, paint);
